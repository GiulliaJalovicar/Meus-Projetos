...
cred =
credentials.Certificate('/content/drive/MyDrive/FIREBASE/sala-f9ef4-fir
ebase-adminsdk-fbsvc-581bee86ca.json')
firebase_admin.initialize_app(cred, {
 'databaseURL' : 'https://sala-f9ef4-default-rtdb.firebaseio.com/'
})
...
missoes_ref.set({
 ...
 'completada_por': ['003', '004', '010', '013', '014', '016',
'017', '019', '020', '021', '024'],
 'status': 'completa'
 },
 'm2': {
 ...
 'descricao': 'Chefe inicial da campanha',
 'completada_por': ['001', '003', '004', '004', '005', '006',
'007', '008', '009', '011', '012', '013', '014', '015', '016', '017',
